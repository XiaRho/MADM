...
from ...common.data.cityscapes_rgb_to_fmb_9_infrared_semseg import dataloader
from ...common.train import train
from ...common.optim import AdamW as optimizer

model.lora_configs = []  # --lora_configs ''
model.target_modality = 'Infrared'
...
model.vae_decoder_loss_weight = [1.0, 1.0]  # --vae_decoder_loss_weight 20.0
