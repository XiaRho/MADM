...
from ...common.data.cityscapes_rgb_to_deliver_11_depth_semseg import dataloader
from ...common.train import train
from ...common.optim import AdamW as optimizer

model.lora_configs = []  # --lora_configs ''
model.target_modality = 'Depth'
...
model.rev_noise_end_iter = 5000  # --rev_noise_end_iter 5000 
model.rev_noise_gradually = True  # --rev_noise_gradually
model.max_iter = train.max_iter  # --rev_noise_gradually
model.denoise_timestep_range = [60, 61]  # --denoise_timestep_range 60 61
# --vae_decoder_loss st
model.vae_decoder_loss = 'st'
...
model.vae_decoder_loss_weight = [1.0, 1.0]  # --vae_decoder_loss_weight 1.0 1.0
