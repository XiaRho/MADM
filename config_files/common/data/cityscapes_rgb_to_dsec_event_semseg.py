...
dataloader.train = L(build_d2_train_dataloader)(
    dataset=L(CrossModalityDataset)(
        json_path='/data/json_file/Cityscapes_RGB_to_DSEC_Event_train.json',
        source_root_path='???',
        target_root_path='???',
        train_or_test='train',
        source_resize_h_w=[512, 1024],
        source_crop_size_h_w=[512, 512],
        target_resize_h_w=[512, 768],
        target_crop_size_h_w=[512, 512],
        label_convert=[[0, 5], [1, 6], [2, 1], [3, 9], [4, 2], [5, 4], [6, 10], [7, 10], [8, 7], [9, 7], [10, 0], [11, 3], [12, 3], 
...
dataloader.test = L(build_d2_test_dataloader)(
    dataset=L(CrossModalityDataset)(
        json_path='/data/json_file/Cityscapes_RGB_to_DSEC_Event_test.json',
        source_root_path='???',
        target_root_path='???',
        train_or_test='test',
        names='Cityscapes_RGB_to_DSEC_Event',
