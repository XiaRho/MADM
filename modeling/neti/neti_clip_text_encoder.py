...
from .net_clip_text_embedding import NeTICLIPTextEmbeddings, NeTIBatch
...
class NeTICLIPTextTransformer(CLIPTextTransformer):
    ...
    def forward_wo_neti(self, input_ids):
        ...
        token_embedding = self.embeddings.forward_wo_neti(input_ids=input_ids)  # [B, 77, 768]

        bsz, seq_len = input_shape
        # CLIP's text model uses causal mask, prepare it here.
        # https://github.com/openai/CLIP/blob/cfcffb90e69f37bf2ff1e988237a0fbe41f33c04/clip/model.py#L324
        causal_attention_mask = self._build_causal_attention_mask(bsz, seq_len, token_embedding.dtype).to(
